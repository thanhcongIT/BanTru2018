    ...
    public partial class UsThongKeThucPham : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void export()
        {
            try
            {
                ...
                worksheet.Cells[7, 1] = "Tên thực phẩm:" + gridView1.GetRowCellValue(gridView1.FocusedRowHandle,gridView1.Columns["Name"]);
                ...
                for (int i = 0; i < gridView3.RowCount; i++)
                {
                    ...
                    worksheet.Cells[10 + i, 2] = gridView3.GetRowCellValue(i,gridView3.Columns["OrderName"]);
                    worksheet.Range["B" + 10 + i + "", "C" + 10 + i + ""].MergeCells = true;//nhập 2 cột liền kề nhau
                    worksheet.Cells[10 + i, 4] = gridView3.GetRowCellValue(i, gridView3.Columns["PriceOfUnit"]);
                    worksheet.Cells[10 + i, 5] = gridView3.GetRowCellValue(i, gridView3.Columns["Unit"]);
                    worksheet.Cells[10 + i, 6] = gridView3.GetRowCellValue(i, gridView3.Columns["QuantityOfUnit"]).ToString();
                    worksheet.Cells[10 + i, 7] = gridView3.GetRowCellValue(i, gridView3.Columns["TotalPrice"]);
                    //nhân viên lập hóa đơn
                    Employee a = new Employee();
                    a = dt.GetByID((int)gridView3.GetRowCellValue(i, gridView3.Columns["EmployeeID"]));
                    worksheet.Cells[10 + i, 8] = a.FirstName + " " + a.LastName;
                    worksheet.Cells[10 + i, 9] = gridView3.GetRowCellValue(i, gridView3.Columns["Date"]);
                }
                int dongData = gridView3.RowCount;

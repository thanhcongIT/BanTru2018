...
namespace QLHSBanTru2018_Demo_V1.QLThuChi
{
    public partial class USCacKhoanThuTheoLop : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                ClassStudentDAO dt = new ClassStudentDAO();
                ClassStudentDAO.StudentID = (int)grDanhSachHocSinh.GetRowCellValue(e.FocusedRowHandle, "StudentID");
        ...
        private void gridView1_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                ...
                a = dt.ListReceivableDetail_Student((int)grDanhSachHocSinh.GetListSourceRowCellValue(rowindex, "StudentID"));

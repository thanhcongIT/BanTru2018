...
namespace DataConnect.DAO.ThanhCongTC.DataSet {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class OrderDetailDataTable : global::System.Data.TypedTableBase<OrderDetailRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public OrderDetailRow AddOrderDetailRow(OrderRow parentOrderRowByOrder_OrderDetail, int IngredientID, decimal PriceOfUnit, double QuantityOfUnit, decimal TotalPrice, bool Status, string Name, string Unit) {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("OrderDetailKey2", new global::System.Data.DataColumn[] {
                                this.columnOrderID,
...
namespace DataConnect.DAO.ThanhCongTC.DataSet.DataSet1TableAdapters {
    ...
    public partial class OrderDetailTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        OrderDetail.OrderID, OrderDetail.IngredientID, OrderDetail.PriceOfUnit, OrderDetail.QuantityOfUnit, OrderDetail.TotalPrice, OrderDetail.Status, Ingredient.Name, Ingredient.Unit
FROM            OrderDetail INNER JOIN
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        [Order].OrderID AS Expr1, [Order].OrderName AS Expr2, [Order].TotalPrice AS Expr3, [Order].Date AS Expr4, [Order].*, [Order].EmployeeID AS Expr5, [Order].Status AS Expr6, Employee.FirstName, Employee.LastName
